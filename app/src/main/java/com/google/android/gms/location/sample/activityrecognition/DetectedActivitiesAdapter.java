...
//                    detectedActivitiesMap.get(Constants.MONITORED_ACTIVITIES[i]) : 0;
            if(!(i==0 || i==2))
            tempList.add(new DetectedActivity(Constants.MONITORED_ACTIVITIES[i], 0));
        }
        tempList.add(new DetectedActivity(Constants.MONITORED_ACTIVITIES[2], 30));
        tempList.add(new DetectedActivity(Constants.MONITORED_ACTIVITIES[0], 70));
//        tempList.add(new DetectedActivity(Constants.MONITORED_ACTIVITIES[4], 80));
